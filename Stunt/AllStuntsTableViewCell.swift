//
//  AllStuntsTableViewCell.swift
//  Stunt
//
//  Created by Casey Shimata on 4/25/17.
//  Copyright © 2017 Casey Shimata. All rights reserved.
//

import UIKit

class AllStuntsTableViewCell: UITableViewCell {
    @IBOutlet weak var date_time_outlet: UILabel!
    @IBOutlet weak var username_outlet: UILabel!
    ...
    func set_db_item_at_index_to_cell_items(){
        print("***** creating the cell ----allstuntstableviewCell 41")
        username_outlet.text = _model?.username
